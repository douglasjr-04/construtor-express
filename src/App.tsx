...
const App = () => {
  ...
  const faqs = [
    ...
    { question: "Para quem é este template?", answer: "Engenheiros, Arquitetos, técnicos em edificações, projetistas, desenhistas de estruturas metálicas e pré-moldadas." },
    { question: "Posso modificar livremente os projetos?", answer: "Sim! Todos os projetos são 100% editáveis." },
    { question: "Como recebo o acesso ao pack?", answer: "Após a confirmação do pagamento, enviamos tudo para seu e-mail imediatamente." },
    { question: "E se eu não gostar do projeto?", answer: "RISCO ZERO. GARANTIA DE 07 DIAS. Se você não economizar 100 horas de trabalho, devolvemos seu dinheiro. E você AINDA FICA com os Bônus! A confiança no nosso material é absoluta." }
  ];
    ...
    <div className="min-h-screen bg-[#050505] text-white font-sans selection:bg-primary/30 selection:text-white overflow-x-hidden antialiased">
      ...
      <div className="bg-primary py-2 px-4 text-center sticky top-0 z-[110]">
        <p className="text-[9px] md:text-xs font-black uppercase tracking-[0.1em] md:tracking-[0.2em] flex items-center justify-center gap-2">
          <AlertCircle className="w-3 h-3 md:w-4 md:h-4 shrink-0" /> 🚨 85% das vagas do APP já preenchidas! 🚨
        </p>
      </div>
      ...
      <section className="relative min-h-[85vh] md:min-h-screen flex items-center pt-16 md:pt-32 pb-12 md:pb-20 overflow-hidden">
        ...
        <div className="container mx-auto px-4 md:px-6 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <motion.h1 initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }} className="text-4xl md:text-7xl xl:text-8xl font-black tracking-tighter mb-4 md:mb-8 leading-[0.95] md:leading-[0.9]">
              100 PROJETOS <br />
              <span className="text-white italic text-3xl md:text-7xl xl:text-8xl">DE CASAS</span> <br />
              <span className="text-primary italic">POPULARES.</span>
            </motion.h1>
            <motion.p initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }} className="text-base md:text-xl text-white/50 mb-8 md:mb-12 max-w-2xl mx-auto leading-relaxed font-light px-4 md:px-0">
              Escolha o modelo, baixe as plantas, o orçamento e a lista de materiais para começar a construir com segurança e economia
            </motion.p>
      ...
      <section id="para-quem" className="py-12 md:py-24 bg-[#080808]">
        <div className="container mx-auto px-6">
          <div className="max-w-3xl mx-auto text-center mb-10 md:mb-24">
            ...
            <p className="text-white/40 font-medium tracking-widest text-[10px] md:text-[10px] uppercase">Se você marcou 2 ou mais perfis, essa coleção foi feita pra você!</p>
          </div>
          <div className="grid md:grid-cols-2 gap-4 md:gap-6">
            {[
              { title: "Saindo do Aluguel", desc: "Já tem o terreno e quer começar certo, com orçamento claro e projeto profissional." },
              { title: "Economia Inteligente", desc: "Lista de materiais e simulador de custos eliminam desperdícios. Economize até 50%!" },
              { title: "Investidor Imobiliário", desc: "Variedade de metragens e plantas aprovadas para executar rápido e com menos risco." },
              { title: "Profissional de Obras", desc: "Plantas técnicas e checklists para canteiro que sua equipe consegue seguir sem erros." }
            ].map((item, i) => (
      ...
      <section className="py-12 md:py-24 overflow-hidden bg-[#050505]">
        <div className="container mx-auto px-6 mb-8 md:mb-20">
          <h2 className="text-3xl md:text-6xl font-black tracking-tight uppercase leading-tight">UMA PRÉVIA DO QUE <br /><span className="text-white/30 italic text-xl md:text-5xl">VOCÊ VAI RECEBER</span></h2>
        </div>
      ...
      <section id="conquistas" className="py-12 md:py-24 relative">
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
            {[
              { icon: <DollarSign />, title: "Economia Real", desc: "Até 50% de redução nos custos com lista por etapa e zero desperdício." },
              { icon: <Layers />, title: "Projeto Completo", desc: "Arquitetônico + elétrica + hidráulica prontos. Zero necessidade de contratar separado." },
              { icon: <Award />, title: "Aprovação Rápida", desc: "Documentos compatíveis com prefeituras reduzem atrasos burocráticos." },
              { icon: <Calculator />, title: "Controle Total", desc: "Simulador automático por região prevê gastos por fase. Sem surpresas!" },
              { icon: <Layout />, title: "Visualize Antes", desc: "Renderizações 3D para tomar decisões com total confiança." },
              { icon: <Smartphone />, title: "Modo Obra", desc: "Versão simplificada que o pedreiro entende e consegue executar no celular." }
            ].map((item, i) => (
      ...
      <section id="pricing" className="py-12 md:py-24 bg-[#080808]">
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-4xl mx-auto text-center mb-10 md:mb-24">
            <h2 className="text-4xl md:text-7xl font-black tracking-tight mb-4 md:mb-8 uppercase leading-tight">PLANO DE <span className="text-white/30 italic block md:inline">INVESTIMENTO</span></h2>
            <p className="text-white/40 text-[10px] md:text-[11px] font-bold uppercase tracking-widest md:tracking-[0.3em]">Acesso vitalício direto do seu computador</p>
          </div>
          
          <div className="grid lg:grid-cols-2 gap-6 md:gap-10 max-w-6xl mx-auto items-stretch px-2 md:px-0">
            {/* Mega Pack Card */}
            <div className="relative group h-full">
              ...
              <div className="relative bg-[#0a0a0a] rounded-[2rem] md:rounded-[4rem] p-6 md:p-16 border border-white/5 h-full flex flex-col overflow-hidden">
                <div className="flex justify-between items-start mb-8 md:mb-12">
                  <div>
                    <h3 className="text-3xl md:text-4xl font-black mb-1 tracking-tighter italic">MEGA PACK</h3>
                ...
                <ul className="space-y-3 md:space-y-4 mb-10 md:mb-16 flex-grow">
                  {[
                    "100+ Projetos Completos - R$ 297",
                    "Renderizações 3D de Todos - R$ 60",
                    "Lista Completa de Materiais - R$ 28",
                    "Planilha PRO de Custos - R$ 97",
                    "PDFs Otimizados 'Modo Obra' - R$ 20",
                    "6 BÔNUS EXCLUSIVOS - R$ 390"
                  ].map((item, i) => (
                    <li key={i} className="flex items-center gap-3 md:gap-4 text-white/70 text-sm md:text-sm font-bold">
                      <CheckCircle2 className="w-5 h-5 md:w-5 md:h-5 text-primary shrink-0" /> {item}
                    </li>
                  ))}
                </ul>
                ...
                <div className="mt-auto pt-8 md:pt-10 border-t border-white/5">
                  <div className="mb-6 md:mb-8">
                    <p className="text-white/20 line-through font-bold text-lg md:text-xl mb-1 tracking-tighter">Valor Total: R$ 890,00</p>
                    <div className="flex items-baseline gap-2 md:gap-3">
                      <span className="text-5xl md:text-7xl font-black tracking-tighter">R$ 37,90</span>
                      <span className="text-primary font-black text-[10px] md:text-sm uppercase tracking-widest italic">Ou 6x R$ 7,24</span>
                    </div>
                  </div>
                  <a 
            ...
            {/* Basic Pack Card */}
            <div className="bg-white/5 rounded-[2rem] md:rounded-[4rem] p-6 md:p-16 border border-white/5 flex flex-col justify-between">
              <div>
                <h3 className="text-2xl md:text-3xl font-black mb-6 md:mb-8 tracking-tighter uppercase">PACK BÁSICO</h3>
                <ul className="space-y-4 md:space-y-6 mb-10 md:mb-16">
                  {[
                    "10+ Projetos Completos",
                    "Arquitetônico + Elétrica + Hidráulica",
                    "Garantia de 07 dias",
                    "Acesso Vitalício"
                  ].map((item, i) => (
                    <li key={i} className="flex items-center gap-3 md:gap-4 text-white/40 text-sm md:text-sm font-medium">
                      <Check className="w-5 h-5 text-white/20" /> {item}
                    </li>
                  ))}
                </ul>
              </div>
              <div>
                ...
                <button 
                  ...
                  className="w-full border border-white/10 py-5 md:py-6 rounded-2xl md:rounded-3xl font-black text-white hover:bg-white hover:text-black transition-all text-sm md:text-lg uppercase tracking-widest"
                >
                  Selecionar Básico
                </button>
              </div>
      ...
      <section className="py-12 md:py-24 bg-white text-black text-center px-6">
        <div className="container mx-auto max-w-3xl">
          ...
          <h2 className="text-3xl md:text-4xl font-black tracking-tight mb-4 md:mb-8 leading-tight">RISCO ZERO. <br className="md:hidden" /> GARANTIA DE 07 DIAS.</h2>
          <p className="text-base md:text-xl font-medium leading-relaxed opacity-60">
            Se você não economizar 100 horas de trabalho, devolvemos seu dinheiro. E você AINDA FICA com os Bônus! A confiança no nosso material é absoluta.
          </p>
        </div>
      </section>
      ...
      <footer className="py-12 md:py-20 border-t border-white/5 bg-[#050505]">
        <div className="container mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-8 md:gap-10 text-center md:text-left">
          ...
          <div className="text-white/20 text-[9px] md:text-[10px] font-medium uppercase tracking-widest">© 2025 CONSTRUTOR EXPRESS. TODOS OS DIREITOS RESERVADOS.</div>
